...
plt.subplot()
plt.title("Desempeño A C1 FLOAT64")
...
plt.grid()
plt.savefig("Desempeño A C1 FLOAT64")
plt.show()
...
plt.subplot()
plt.title("Desempeño A C2 FLOAT64")
...
plt.xticks(eje_x, eje_x, rotation=45)
plt.grid()
plt.savefig("Desempeño A C2 FLOAT64")
plt.show()
...
plt.subplot()
plt.title("Desempeño A C3 FLOAT64")
...
plt.xticks(eje_x, eje_x, rotation=45)
plt.grid()
plt.savefig("Desempeño A C3 FLOAT64")
plt.show()
...
plt.subplot()
plt.title("Desempeño A C4 FLOAT64")
...
plt.xticks(eje_x, eje_x, rotation=45)
plt.grid()
plt.savefig("Desempeño A C4 FLOAT64")
plt.show()
...
plt.subplot()
plt.title("Desempeño A C5 FLOAT64")
...
plt.xticks(eje_x, eje_x, rotation=45)
plt.grid()
plt.savefig("Desempeño A C5 FLOAT64")
plt.show()
...
plt.subplot()
plt.title("Desempeño A C6 FLOAT64")
...
plt.xticks(eje_x, eje_x, rotation=45)
plt.grid()
plt.savefig("Desempeño A C6 FLOAT64")
plt.show()
