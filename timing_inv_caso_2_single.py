...
fid = open("timing_inv_caso_2_single.txt","w")
i = 0
...
fid = open("timing_inv_caso_2_single.txt","r")
...
plt.subplot(2,1,1)
plt.title("Rendimiento caso_2_single")
...
plt.savefig("RENDIMIENTO caso 2 single")
plt.show()
