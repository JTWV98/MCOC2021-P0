...
#LONGDOUBLE
Ns_h_1 = [1, 10 ,100, 1000, 2000, 2100, 2200, 2400, 2500 ,3000, 3400, 3500, 4000, 4400, 4500, 5000, 7500, 10000]
dt_ensamblaje_h1 = []
dt_inversion_h1=[]
bytes_total_h1=[]


fid = open("timing_inv_caso_1_longdouble.txt","w")
i = 0
...
fid = open("timing_inv_caso_1_longdouble.txt","r")
...
plt.subplot(2,1,1)
plt.title("Rendimiento caso_1_longdouble")
...
plt.savefig("RENDIMIENTO caso 1 longdouble")
plt.show()
