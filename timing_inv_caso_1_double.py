...
fid = open("timing_inv_caso_1_double.txt","w")
i = 0
...
fid = open("timing_inv_caso_1_double.txt","r")
...
plt.subplot(2,1,1)
plt.title("Rendimiento caso_1_double")
...
plt.savefig("RENDIMIENTO caso 1 double")
plt.show()