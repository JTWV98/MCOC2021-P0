...
fid = open("laplaciana_llena.txt","w")
i = 0
while i < 10:
    print()
    print()
...
dte = []
dts = []
fid = open("laplaciana_llena.txt", "r")
...
plt.plot([3,10000],[dte[0],max(dte)],linestyle = "--", color="orange", label="O(N)")
plt.plot([10,10000],[dte[0]**2,max(dte)],linestyle = "--", color="green", label="O(N^2)")
plt.plot([100,10000],[dte[0]**3,max(dte)],linestyle = "--",color="red", label="O(N^3)")
plt.plot([400,10000],[dte[0]**4,max(dte)],linestyle = "--",color="purple", label="O(N^3)")
...
plt.plot([3,10000],[dts[0],max(dts)],linestyle = "--", color="orange", label="O(N)")
plt.plot([10,10000],[dts[0]**2,max(dts)],linestyle = "--", color="green", label="O(N^2)")
plt.plot([100,10000],[dts[0]**3,max(dts)],linestyle = "--",color="red", label="O(N^3)")
plt.plot([400,10000],[dts[0]**4,max(dts)],linestyle = "--",color="purple", label="O(N^4)")
plt.axis([0,Ns[-1],0.0001, 600])
