...
fid = open("timing_inv_caso_1_single.txt","w")
i = 0
...
fid = open("timing_inv_caso_1_single.txt","r")
...
plt.subplot(2,1,1)
plt.title("Rendimiento caso_1_single")
...
plt.savefig("RENDIMIENTO caso 1 single")
plt.show()
