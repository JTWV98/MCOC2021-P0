...
fid = open("timing_inv_caso_3_double.txt","w")
i = 0
...
fid = open("timing_inv_caso_3_double.txt","r")
...
plt.subplot(2,1,1)
plt.title("Rendimiento caso_3_double")
...
plt.savefig("RENDIMIENTO caso 3 double")
plt.show()