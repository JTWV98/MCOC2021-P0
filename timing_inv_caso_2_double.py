...
fid = open("timing_inv_caso_2_double.txt","w")
i = 0
...
fid = open("timing_inv_caso_2_double.txt","r")
...
plt.subplot(2,1,1)
plt.title("Rendimiento caso_2_double")
...
plt.savefig("RENDIMIENTO caso 2 double")
plt.show()