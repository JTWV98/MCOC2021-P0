...
fid = open("timing_inv_caso_3_longdouble.txt","w")
i = 0
...
fid = open("timing_inv_caso_3_longdouble.txt","r")
...
plt.subplot(2,1,1)
plt.title("Rendimiento caso_3_longdouble")

for i in range(len(Ns)):

    plt.subplot(2,1,1).loglog(Ns[i*10:(i+1)*10], dt_ensamblaje_h1[i*10:(i+1)*10], "o-")
    # print(f"{Ns[i*10:(i+1)*10], dt_ensamblaje_h1[i*10:(i+1)*10]}")
 	#print (Ns[0])
...
plt.savefig("RENDIMIENTO caso 3 longdouble")
plt.show()