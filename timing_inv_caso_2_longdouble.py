...
fid = open("timing_inv_caso_2_longdouble.txt","w")
i = 0
...
fid = open("timing_inv_caso_2_longdouble.txt","r")
...
plt.subplot(2,1,1)
plt.title("Rendimiento caso_2_longdouble")
...
plt.savefig("RENDIMIENTO caso 2 longdouble")
plt.show()